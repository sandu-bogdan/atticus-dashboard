...
// Set cURL options
curl_setopt($ch, CURLOPT_URL, $glancesApiEndpoint);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);

// Set basic authentication
curl_setopt($ch, CURLOPT_HTTPAUTH, CURLAUTH_BASIC);
curl_setopt($ch, CURLOPT_USERPWD, "$glancesUsername:$glancesPassword");
...
if ($response !== false) {
    ...
    if ($data && isset($data['cpu']['total'])) {
        ...
        echo json_encode([
            ...
            'memUsed' => $memUsed,
            'glancesUrl' => $glancesUrl,
            'glancesName' => $glancesName
        ]);
    } else {
